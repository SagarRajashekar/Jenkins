...
public class BoysTrousersPageTest extends Base_Test {
	
	@Test(dataProvider = "testData")

	public void boysTrousers(String email,String pwd) {
		...
		kp.clickBoysTrousers();
		if(driver.getCurrentUrl().contains("Trousers")) {
			test.log(LogStatus.PASS, "Boys Trousers page is displayed");
		}else {
			test.log(LogStatus.FAIL, "Boys Trousers page is not displayed");

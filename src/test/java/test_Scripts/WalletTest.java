...
public class WalletTest extends Base_Test{
	
	@Test(dataProvider = "testData")

	public void walletIcon(String email,String pwd) {
		...
		hp.clickOnwalletIcon();
		if(driver.getCurrentUrl().contains("my-wallet")) {
			test.log(LogStatus.PASS, "My wallet page is displayed");
		}else {
			test.log(LogStatus.FAIL, "My wallet page is not displayed");

...
public class KidsBoysShirtsPageTest extends Base_Test{
	
	@Test(dataProvider = "testData")

	public void boysShirts(String email,String pwd) {
		...
		kp.clickBoysShirts();
		if(driver.getCurrentUrl().contains("boys-shirt")) {
			test.log(LogStatus.PASS, "Boys shirt page is displayed");
		}else {
			test.log(LogStatus.FAIL, "Boys shirt page is not displayed");

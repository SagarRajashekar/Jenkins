...
public class KidsBoysJeansPageTest extends Base_Test{
	
	@Test(dataProvider = "testData")

	public void boysJeans(String email,String pwd) {
		...
		kp.clickBoysJeans();
		if(driver.getCurrentUrl().contains("boys-jeans")) {
			test.log(LogStatus.PASS, "Boys jeans page is displayed");
		}else {
			test.log(LogStatus.FAIL, "Boys jeans page is not displayed");

...
public class GirlsTshirtsPageTest extends Base_Test {
	
	@Test(dataProvider = "testData")

	public void girlsTshirts(String email,String pwd) {
		...
		kp.clickGirlsTshirts();
		if(driver.getCurrentUrl().contains("girls-tshirt")) {
			test.log(LogStatus.PASS, "Girls tshirt page is displayed");
		}else {
			test.log(LogStatus.FAIL, "Girls tshirt page is not displayed");

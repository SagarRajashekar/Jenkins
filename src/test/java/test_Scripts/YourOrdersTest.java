...
public class YourOrdersTest extends Base_Test{
	
	@Test(dataProvider = "testData")

	public void yourOrdersIcon(String email,String pwd) {
		...
		hp.clickOnYourOrders();
		if(driver.getCurrentUrl().contains("myorder")) {
			test.log(LogStatus.PASS, "My order page placed is displayed");
		}else {
			test.log(LogStatus.FAIL, "My order page placed is not displayed");
